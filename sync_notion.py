...
# Also update user-request.html if it exists
if os.path.exists('user-request.html'):
    ...
    ur_html = replace_var(ur_html, 'TEAM_REQ_DATA', team_req)
...
# Copy to Desktop if running locally (not in CI)
import os, shutil
if os.environ.get('GITHUB_ACTIONS') != 'true':
    desktop_dst = os.path.expanduser('~/Desktop/Team Project Monitoring.html')
    try:
        shutil.copy2('index.html', desktop_dst)
